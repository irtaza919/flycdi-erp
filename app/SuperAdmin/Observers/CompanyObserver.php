...
class CompanyObserver
{
    ...
    {
        // We will not insert using model
        // Becuase if we insert it using model then
        // model observer will insert the company id
        // which is logged in
        // This will cause in case of register from front
