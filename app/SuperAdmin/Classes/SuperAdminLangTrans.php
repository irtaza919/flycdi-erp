...
class SuperAdminLangTrans
{
    public static $mainTranslations = [
        ...
        'subscription_plans' => [
            ...
            'payment_success' => 'Payment Successful... Please Give Us Some Time To Update...',
            'payment_failed' => 'Payment failed... contact to service admin',
        ],
        ...
        'website_settings' => [
            ...
            'register_phone_text' => 'Phone Text',
        ...
        'messages' => [
            ...
            'account_message' => 'Please provide details for your account',
        ],
        'front_website' => [
            'condition' => 'I agree to the Terms & Conditions of Stockifly',
            'shop_name' => 'Shop Name',
        ],
        'common' => [
            'back_super_admin' => 'Back to SuperAdmin',
        ],
    ];
}
